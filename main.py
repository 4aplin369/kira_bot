...
MILESTONES = [
    ...
    # Недельный отсчёт на финише.
    ("week5", "🗓 *Осталось 5 недель!*\nМалыш почти готов. Отдыхай побольше 💛",
     lambda week, days: days <= 35),
    ("week4", "🗓 *Осталось 4 недели!*\nФинишная прямая — совсем скоро вы встретитесь.",
     lambda week, days: days <= 28),
    ("week3", "🗓 *Осталось 3 недели!*\nМалыш уже считается почти доношенным. Ты молодец 💛",
     lambda week, days: days <= 21),
    ("week2", "🗓 *Осталось 2 недели!*\nВот-вот. Слушай своё тело и малыша.",
     lambda week, days: days <= 14),
    ("week1", "🍼 *Осталась всего неделя!*\nМалыш может появиться со дня на день 💛",
     lambda week, days: days <= 7),
    ("final", "💛 *Совсем скоро!*\nБуквально считанные дни. Дыши и верь — всё будет "
     "хорошо.", lambda week, days: days <= 2),
]
